...
public class LessonTwoRenderer implements Renderer{
	...
	{	
		Log.i(TAG, "Setting cuba position data and setting up buffers");
	...
	private int compileShader(final int shaderType, final String shaderSource){
		...
		if(shaderHandle != 0){
			...
			if(compileStatus[0] == 0){
				...
				shaderHandle = 0;
				throw new RuntimeException("Error compiling " + shaderType + " shader. Shader info log: " + GLES20.glGetShaderInfoLog(shaderHandle));
			}
		}
		else{
